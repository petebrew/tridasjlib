    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<Name> theNames;
            theNames = (this.isSetNames()?this.getNames():null);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<Name> lhsNames;
            lhsNames = (this.isSetNames()?this.getNames():null);
            List<Name> rhsNames;
            rhsNames = (that.isSetNames()?that.getNames():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AbstractFeatureBaseType) {
            final AbstractFeatureBaseType copy = ((AbstractFeatureBaseType) draftCopy);
            ...
            if (this.isSetNames()) {
                ...
                sourceNames = (this.isSetNames()?this.getNames():null);
                @SuppressWarnings("unchecked")
                List<Name> copyNames = ((List<Name> ) strategy.copy(LocatorUtils.property(locator, "names", sourceNames), sourceNames));
                copy.unsetNames();
