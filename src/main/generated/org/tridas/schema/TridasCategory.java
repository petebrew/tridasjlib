 ...
 *       &lt;attribute name="normalTridas" type="{http://www.tridas.org/1.2.1}normalTridasCategory" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class TridasCategory
    ...
    implements Serializable, CopyTo, Copyable, Equals, HashCode, ToString, NormalTridasVoc<NormalTridasCategory>
{

    private final static long serialVersionUID = 1001L;
    @XmlAttribute(name = "normalTridas")
    protected NormalTridasCategory normalTridas;
    ...
    public void toString(ToStringBuilder toStringBuilder) {
        ...
        {
            NormalTridasCategory theNormalTridas;
    ...
    public void equals(Object object, EqualsBuilder equalsBuilder) {
        if (!(object instanceof TridasCategory)) {
        ...
        final TridasCategory that = ((TridasCategory) object);
