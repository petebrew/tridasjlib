 ...
 *       &lt;attribute name="type" use="required" type="{http://www.tridas.org/1.2.2}normalTridasDatingType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            NormalTridasDatingType lhsType;
            lhsType = this.getType();
            NormalTridasDatingType rhsType;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TridasDating) {
            final TridasDating copy = ((TridasDating) draftCopy);
            if (this.isSetType()) {
                NormalTridasDatingType sourceType;
                sourceType = this.getType();
                NormalTridasDatingType copyType = ((NormalTridasDatingType) strategy.copy(LocatorUtils.property(locator, "type", sourceType), sourceType));
