    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TridasIdentifier)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TridasIdentifier that = ((TridasIdentifier) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TridasIdentifier) {
            final TridasIdentifier copy = ((TridasIdentifier) draftCopy);
            if (this.isSetValue()) {
                String sourceValue;
            ...
            if (this.isSetDomain()) {
                ...
                String copyDomain = ((String) strategy.copy(LocatorUtils.property(locator, "domain", sourceDomain), sourceDomain));
