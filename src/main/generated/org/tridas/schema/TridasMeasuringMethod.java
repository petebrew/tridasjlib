 ...
 *       &lt;attribute name="normalTridas" type="{http://www.tridas.org/1.2.2}normalTridasMeasuringMethod" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class TridasMeasuringMethod
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString, NormalTridasVoc<NormalTridasMeasuringMethod>
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            NormalTridasMeasuringMethod lhsNormalTridas;
            lhsNormalTridas = this.getNormalTridas();
            NormalTridasMeasuringMethod rhsNormalTridas;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TridasMeasuringMethod) {
            final TridasMeasuringMethod copy = ((TridasMeasuringMethod) draftCopy);
            if (this.isSetNormalTridas()) {
                NormalTridasMeasuringMethod sourceNormalTridas;
                sourceNormalTridas = this.getNormalTridas();
                NormalTridasMeasuringMethod copyNormalTridas = ((NormalTridasMeasuringMethod) strategy.copy(LocatorUtils.property(locator, "normalTridas", sourceNormalTridas), sourceNormalTridas));
