 ...
 *       &lt;attribute name="normalTridas" type="{http://www.tridas.org/1.2.2}normalTridasShape" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class TridasShape
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString, NormalTridasVoc<NormalTridasShape>
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            NormalTridasShape lhsNormalTridas;
            lhsNormalTridas = this.getNormalTridas();
            NormalTridasShape rhsNormalTridas;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TridasShape) {
            final TridasShape copy = ((TridasShape) draftCopy);
            if (this.isSetNormalTridas()) {
                NormalTridasShape sourceNormalTridas;
                sourceNormalTridas = this.getNormalTridas();
                NormalTridasShape copyNormalTridas = ((NormalTridasShape) strategy.copy(LocatorUtils.property(locator, "normalTridas", sourceNormalTridas), sourceNormalTridas));
