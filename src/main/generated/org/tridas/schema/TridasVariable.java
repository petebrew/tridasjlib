 ...
 *       &lt;attribute name="normalTridas" type="{http://www.tridas.org/1.2.2}normalTridasVariable" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class TridasVariable
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString, NormalTridasVoc<NormalTridasVariable>
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            NormalTridasVariable lhsNormalTridas;
            lhsNormalTridas = this.getNormalTridas();
            NormalTridasVariable rhsNormalTridas;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TridasVariable) {
            final TridasVariable copy = ((TridasVariable) draftCopy);
            if (this.isSetNormalTridas()) {
                NormalTridasVariable sourceNormalTridas;
                sourceNormalTridas = this.getNormalTridas();
                NormalTridasVariable copyNormalTridas = ((NormalTridasVariable) strategy.copy(LocatorUtils.property(locator, "normalTridas", sourceNormalTridas), sourceNormalTridas));
