    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            DatingSuffix lhsSuffix;
            lhsSuffix = this.getSuffix();
            DatingSuffix rhsSuffix;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Year) {
            final Year copy = ((Year) draftCopy);
            if (this.isSetValue()) {
                Integer sourceValue;
            ...
            if (this.isSetSuffix()) {
                ...
                DatingSuffix copySuffix = ((DatingSuffix) strategy.copy(LocatorUtils.property(locator, "suffix", sourceSuffix), sourceSuffix));
